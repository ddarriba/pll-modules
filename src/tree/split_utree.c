...
{
       0,    89,    89,    95,   114,   139,   139,   140,   140,   141,
     141,   142
};
#endif
...
#else
static void
yy_symbol_print (yyoutput, yytype, yyvaluep, params_ptr)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    void * params_ptr;
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, int yyrule, void * params_ptr)
#else
static void
yy_reduce_print (yyvsp, yyrule, params_ptr)
    YYSTYPE *yyvsp;
    int yyrule;
    void * params_ptr;
#endif
...
do {					\
  if (yydebug)				\
    yy_reduce_print (yyvsp, Rule, params_ptr); \
} while (YYID (0))
...
#else
static void
yydestruct (yymsg, yytype, yyvaluep, params_ptr)
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
    void * params_ptr;
  ...
  switch (yytype)
    {
      case 12: /* subtree */
/* Line 1398 of yacc.c  */
#line 76 "split_utree.y"
        { };
/* Line 1398 of yacc.c  */
#line 1121 "split_utree.c"
        break;
  ...
  switch (yyn)
    {
        case 2:
/* Line 1792 of yacc.c  */
#line 90 "split_utree.y"
    {
  PLLMOD_UNUSED((yyval.nulval));PLLMOD_UNUSED((yyvsp[(2) - (10)].nulval));
  PLLMOD_UNUSED((yyvsp[(4) - (10)].nulval));PLLMOD_UNUSED((yyvsp[(6) - (10)].nulval)); /* ignore result */
}
    break;

  case 3:
/* Line 1792 of yacc.c  */
#line 96 "split_utree.y"
    {
  PLLMOD_UNUSED((yyval.nulval));PLLMOD_UNUSED((yyvsp[(2) - (7)].nulval));PLLMOD_UNUSED((yyvsp[(4) - (7)].nulval));
  ...
  case 4:
/* Line 1792 of yacc.c  */
#line 115 "split_utree.y"
    {
  PLLMOD_UNUSED((yyval.nulval));
  struct parse_params_t * params = (struct parse_params_t *) params_ptr;

  // find tip index
  int tip_id = string_hash_lookup((yyvsp[(1) - (2)].s),
...
#line 141 "split_utree.y"
  ...
  case 11:
/* Line 1792 of yacc.c  */
#line 142 "split_utree.y"
    { (yyval.d)=(yyvsp[(1) - (1)].d);}
    break;


/* Line 1792 of yacc.c  */
#line 1512 "split_utree.c"
      default: break;
    }
